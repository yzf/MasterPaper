...
\begin{definition}[回答集逻辑程序的补全]
	给定一个逻辑程序$P$，其补全$Comp(P)$是$P$的约束和$P$的克拉克补全(Clark completion)的并集\upcite{lin2004assat}。它包括以下子句：
	\begin{enumerate}
...
Gebser和Schaub在2005年首次提出了正规逻辑程序的基本环(elementary loops)的概念\upcite{gebser2005loops}。2011年，他们又把基本环拓展到析取逻辑程序\upcite{gebser2011elementary}。
...
Gebser等人(2005)给出了基本环的识别方法\upcite{gebser2005loops}，该方法基于基本子图的概念。
